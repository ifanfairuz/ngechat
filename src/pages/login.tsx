    ...
    <div className="m-auto max-w-2xl h-[60vh] min-h-[500px] w-full bg-white rounded-3xl shadow-xl overflow-hidden">
      <div className="flex flex-col text-center justify-center gap-4 h-full py-8">
        <div className="mt-auto mb-8">
          ...
          <h3 className="text-4xl opacity-50 font-title mb-4 -mt-2">Ngechat</h3>
          <p className="opacity-50">Simple Chat App with NextJS</p>
        </div>
        <Link
          href="/api/auth/login"
        ...
        <p className="opacity-50 mb-auto mt-auto text-sm">
